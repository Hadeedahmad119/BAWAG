...
__author__ = 'BAWA G'
__copyright = 'All rights reserved . Copyright  BAWA G'
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/bawag_zeshi/main/server.txt').text
    if to in r:
        ...
        print ' \x1b[1;92mCopy the id and send to BAWA G'
        print ' \x1b[1;92mYour id: ' + to
        raw_input('\x1b[1;93m Press enter to send id')
        os.system('xdg-open https://www.facebook.com/BAWAG.zeshi')
        reg()
...
def log_menu_s():
    s = raw_input(' \x1b[1;94m\xe2\x95\xb0\xe2\x94\x80BAWA G\xe2\x9e\xa4 ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
...
def menu_s():
    ms = raw_input('\x1b[1;97m\xe2\x95\xb0\xe2\x94\x80Ak MZ\xe2\x9e\xa4 ')
    if ms == '1':
        auto_crack()
    elif ms == '2':
        choice_crack()
...
def a_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \x1b[1;97m\xe2\x95\xb0\xe2\x94\x80Ak MZ\xe2\x9e\xa4 ')
    if a_s == '1':
        os.system('clear')
        print logo
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;92m{BAWA G}\x1b[1;91m'
    print 47 * '-'
...
def c_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \x1b[1;97m\xe2\x95\xb0\xe2\x94\x80BAWAG\xe2\x9e\xa4 ')
    if a_s == '1':
        os.system('clear')
        print logo
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94m[BAWA G] \x1b[1;91m'
    print 47 * '-'
...
def n_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94m[Ak MZ] \x1b[1;91m'
    print 47 * '-'
